...
public class HomeCustom {
	...
	public static final String LOGO = "slogo.png";
	public static final String LOGO_MEDIUM = "slogo2.png";
	public static final String LOGO_LARGE = "slogo_large.png";	
	public static final String BACKGROUND_GENERAL_IMG = "Rejilla_Transparente.png";
